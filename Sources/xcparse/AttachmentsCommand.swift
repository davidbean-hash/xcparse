...
struct AttachmentsCommand: Command {
    ...
    var useOriginalName: OptionArgument<Bool>
    ...
    init(parser: ArgumentParser) {
        ...
        useOriginalName = subparser.add(option: "--original-name", shortName: nil, kind: Bool.self, usage: "Use the original attachment name from test code instead of the UUID-based filename")
    ...
    func run(with arguments: ArgumentParser.Result) throws {
        ...
        var options = AttachmentExportOptions(addTestScreenshotsDirectory: false,
                                              ...
                                              useOriginalAttachmentName: arguments.get(self.useOriginalName) ?? false)
